 ...
 * @since 1.0.0
 */
class PeriodicalPress_Issue_Taxonomy{
	...
	/**
	 * The name for registering the Issues taxonomy.
	 *
	 * @since 1.0.0
	 * @access private
	 ...
	 * @var string $taxonomy_name The name for registering the Issues taxonomy.
	 *                            Default 'pp_issue'.
	 */
	public function __construct( $plugin_name, $version, $taxonomy_name = 'pp_issue' ) {
	...
	public static function register_taxonomies() {
		...
		register_taxonomy( $this->taxonomy_name, array( 'post' ), $args );
